...
public class BookingSaga {
    ...
    // Is there a similar parameter to remove the need for validation
    // that an event handler is running for a particular instance of a class?
    ...
    public void on(CardRedeemedEvent event) {
        ...
        if (!partialPayment) { SagaLifecycle.end(); }
    }
